...
class GradualWarmupScheduler(_LRScheduler):
    ...
    def get_lr(self):
        if self.last_epoch - self.ignore_first_iters > self.total_epoch:
        ...
        if self.multiplier == 1.0:
            ...
            return [base_lr * ((self.multiplier - 1.) * (self.last_epoch-self.ignore_first_iters) / self.total_epoch + 1.) for base_lr in self.base_lrs]
